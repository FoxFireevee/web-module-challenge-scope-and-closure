...
// Counter2 is a much simpler code, and counter1 has a function nested within a function.

  2. Which of the two uses a closure? How can you tell?

  // counter2 code is the closure. It is a closure because it calls upon a variable outside of the function. 

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  

// In counter1 the variable count is only accessable within the scope of that function, whereas counter2 has a variable accessable to the global scope. I think counter1 would be preferred if you were pertaining this code to one specific thing vs using counter2 for something more broadly/commonly used. 
...
console.log('Extra', scoreboard(getInningScore, inning, 9));
